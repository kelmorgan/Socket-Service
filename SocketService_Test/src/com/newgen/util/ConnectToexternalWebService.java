...
public class ConnectToexternalWebService {
    ...
    private String sendRequest(String SOAP_inxml,String ServiceName) 
	{
		...
		{ 
                ...
                if (ServiceName.equalsIgnoreCase("SuccessDebit"))
                {
                    EndPointurl = p.getProperty("SuccessDebit");
                }
                if (ServiceName.equalsIgnoreCase("FailureCredit"))
                {
                    EndPointurl = p.getProperty("FailureCredit");
                }
                if (ServiceName.equalsIgnoreCase("fetchAccountBVN"))
                {
                    EndPointurl = p.getProperty("fetchAccountBVN");
                }
